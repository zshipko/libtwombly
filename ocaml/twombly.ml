...
external text_simple : draw -> float -> float -> string -> (int * float) -> unit = "_text_simple"
external set_font : string -> unit = "_set_font"
external text : draw -> float -> float -> string -> (float * float) -> unit = "_text"
